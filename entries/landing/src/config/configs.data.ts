...
export const allData: any = {
  ...
  demo: {
    ...
    cta: 'Browse Boards',
    ctaUrl: '/boards',
    videoUrl: 'https://raw.githubusercontent.com/dht/gdi-assets/main/assets/videos/contextual.mp4',
    videoHeight: 570,
    controls: true,
  },
  'ai-runner': {
    ...
    videoUrl: 'https://raw.githubusercontent.com/dht/gdi-assets/main/assets/videos/iterm.mp4',
    videoLoop: false,
    videoHeight: 520,
    controls: true,
  },
  'dynamic-content': {
    ...
    cta: 'View Examples',
    ctaUrl: '/boards/B-013',
    videoUrl: 'https://raw.githubusercontent.com/dht/gdi-assets/main/assets/videos/dynamic.mp4',
    controls: true,
  },
  'apple-vision': {
    id: 'apple-vision',
