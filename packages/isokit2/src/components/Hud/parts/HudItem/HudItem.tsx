...
export function HudItem(props: HudItemProps) {
  ...
  const { top, left, width, height, clockAngle, isTextOnBottom, x1, y1, x2, y2 } = points;
  ...
  return (
    <Wrapper className={className} data-testid='HudItem-wrapper' color={color} style={style}>
      <Svg
        style={styleSvg}
