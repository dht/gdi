...
export class CalendarBuilder {
  ...
  buildMonth(monthId: number, firstDay: dayjs.Dayjs): IMonthDefinition {
  ...
  buildWeek(weekId: number, firstDayOfWeek: dayjs.Dayjs): IWeekDefinition {
  ...
  buildDay(date: dayjs.Dayjs): IDayDefinition {
