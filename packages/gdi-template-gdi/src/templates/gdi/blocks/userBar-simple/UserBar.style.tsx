...
export const Container = styled.div<{ colors: UserBarColors }>`
    flex: 1;
...
export const Slogan = styled.div<{ colors: UserBarColors }>`
...
export const CTA = styled.a<{ colors: UserBarColors }>`
