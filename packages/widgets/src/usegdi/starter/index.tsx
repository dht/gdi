...
import assetNew from './asset-new';
...
export const starter: IWidgets = {
  ...
  'com.usegdi.starter.asset-list': assetList,
  'com.usegdi.starter.asset-new': assetNew,
  'com.usegdi.starter.asset-preview': assetPreview,
  ...
  'com.usegdi.starter.list-items': listItems,
