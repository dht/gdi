    ...
    blue: {
        desktop: {
            large: {
                ...
                height: 400,
                ratio: 2.5,
                url: 'screenshot.gdi.cta line-basic.blue.desktop.large.webp',
                urlIsRemote: false,
            },
            thumb: {
                width: 1000,
                height: 400,
                ratio: 2.5,
                url: 'screenshot.gdi.cta line-basic.blue.desktop.thumb.webp',
                urlIsRemote: false,
            },
        },
        mobile: {
            large: {
                ...
                url: 'screenshot.gdi.cta line-basic.blue.mobile.large.webp',
                urlIsRemote: false,
            },
            thumb: {
                width: 500,
                height: 1383,
                ratio: 0.3615328994938539,
                url: 'screenshot.gdi.cta line-basic.blue.mobile.thumb.webp',
                urlIsRemote: false,
            },
        },
    },
