...
import { ITimeline, IVisibilityState, Json, Visibility } from '../Hud.types';

export function useTimeline(timeline: ITimeline = []) {
...
export function allVisibility(state = {}, action: Json) {
    const { id } = action;
